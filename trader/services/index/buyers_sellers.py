...
class BuyersSellers(TradeApp):
    ...
    def getBuySellDiff(self):
        ...
        ce_tickers.append(
            "NSE:NIFTY" + self.year + self.month + self.week + str(nifty_atm) + "CE"
        )
        pe_tickers.append(
            "NSE:NIFTY" + self.year + self.month + self.week + str(nifty_atm) + "PE"
        )
        ...
        for ticker in ce_tickers:
            if TRADE_ENV == "prod":
                ...
                diff_buy_sell = (
                    ticker_live["total_buy_quantity"]
                    - ticker_live["total_sell_quantity"]
                )
        ...
        while True:
            ...
            for order in orders:
                ...
                if TRADE_ENV == "prod":
                    ...
                    ticker_live = {"last_price": random.randint(80, 100)}
