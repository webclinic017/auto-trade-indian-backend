...
class BullBearV2(TradeApp):
    ...
    def entryStrategy(self):
        while True:
            ...
            banknifty_historical = self.getHistoricalData('NSE:NIFTY BANK', self.today, self.today, '5minute')
    ...
    def exitStrategy(self):
        while True:
            ...
            banknifty_latest_5min = banknifty_historical.loc[len(banknifty_historical)-2,:]
            ...
            for order in orders:
                ...
                if ticker_type == "BANKNIFTY" and "CE" in ticker:
                    if (
                        ...
                        banknifty_live["last_price"] < banknifty_latest_5min['low']
                    ):
                        ...
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                        print("banknifty live: ", banknifty_live["last_price"], " banknifty latestlow: ", banknifty_latest_5min['low'])
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                ...
                if ticker_type == "NIFTY" and "CE" in ticker:
                    if (
                        ...
                        nifty_live["last_price"] < nifty_latest_5min['low']
                    ):
                        trade = self.generateMarketOrderSellIndexOption(
                            ticker, 50, "EXIT"
                        )
                        ...
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                        print("nifty live: ", nifty_live["last_price"], " nifty latestlow: ", nifty_latest_5min['low'])
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                ...
                if ticker_type == "BANKNIFTY" and "PE" in ticker:
                    if (
                        ...
                        banknifty_live["last_price"] > banknifty_latest_5min['high']
                    ):
                        trade = self.generateMarketOrderSellIndexOption(
                            ticker, 50, "EXIT"
                        )
                        ...
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                        print("banknifty live: ", banknifty_live["last_price"], " banknifty latesthigh: ", banknifty_latest_5min['high'])
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                ...
                if ticker_type == "NIFTY" and "PE" in ticker:
                    if (
                        nifty_live["last_price"] > nifty_latest_5min['high']
                    ):
                        trade = self.generateMarketOrderSellIndexOption(
                            ticker, 50, "EXIT"
                        )
                        ...
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
                        print("nifty live: ", nifty_live["last_price"], " nifty latesthigh: ", nifty_latest_5min['high'])
                        print("\n\n\n*****EXIT CONDITIONS*****\n\n\n")
